...
export default function Filters() {
  ...
  return (
    <div className="flex justify-between items-center mb-4">
      <div>
        <span className="uppercase text-sm to-gray-500 mr-2">Filter by</span>
        <ButtonGroup outline>
      ...
      <div>
        <span className="uppercase text-sm to-gray-500 mr-2">Order by</span>
        <ButtonGroup outline>
      ...
      <div>
        <span className="uppercase text-sm to-gray-500 mr-2">Page size</span>
        <ButtonGroup outline>
